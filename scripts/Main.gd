...
const PATTERN_DESCS := {
	"锐金之极": "5金：命中触发金刃切割方向，当前提供暴击+10%。",
	"生生不息": "5木：击杀回复与战斗续航方向，当前提升最大HP、击杀回复和微量自然回复。",
	"渊流无尽": "5水：潮汐印记与冻结方向，当前缩短冷却并提高减速概率。",
	"焚天烈焰": "5火：灼烧与死亡爆炸方向，当前提升攻击并使攻击附带灼烧。",
	"万钧之重": "5土：致死保护与承伤方向，当前提高减伤。",
	"金水相生": "暴击后衔接水溅射方向，当前提供暴击+8%。",
	"水木相生": "攻击节奏转化为回复，当前提供每秒回复。",
	"木火相生": "延长灼烧并形成传染方向，当前提升攻击与燃烧强度。",
	"火土相生": "受击减伤与反伤方向，当前提供减伤。",
	"土金相生": "蓄力重击方向，当前提供攻击提升。",
	"金木交锋": "相克双元：强化破甲和对重甲敌伤害，但降低自身防护。",
	"木土相争": "相克双元：击杀后取得恢复与机动收益，偏进攻续航。",
	"土水交冲": "相克双元：攻击可制造泥沼减速，但自身移速与闪避节奏受限。",
	"水火不容": "相克双元：攻击可触发蒸汽爆发方向，但防护降低。",
	"火金相克": "相克双元：暴击与灼烧增强，但非暴击伤害降低。",
	"金水木·涌泉": "三元相生链：暴击、水势与生机循环，提供暴击、回复和伤害。",
	"水木火·燎原": "三元相生链：回复催动火势，强化回复与燃烧。",
	"木火土·熔铸": "三元相生链：燃烧后获得厚重攻防收益。",
	"火土金·锻锋": "三元相生链：承压锻锋，强化攻击与暴击。",
	"土金水·沉渊": "三元相生链：减伤蓄势并强化迟滞控制。",
	"火水木·蒸腾": "混合三元：灼烧、蒸汽和木毒转化为毒雾，但燃烧伤害降低。",
	"土水火·泥焰": "混合三元：攻击有概率喷发泥焰，兼具减速和范围伤害，但节奏略沉。",
	"金木火·淬刃": "混合三元：无视部分护甲，暴击可形成火焰溅射方向。",
	"水土金·沉锻": "混合三元：承受高额单击更稳，但回复收益降低。",
	"木火土·灰烬": "混合三元：灼烧击杀后的沃土收益方向，当前提供击杀回复和攻击。",
	"四象轮转": "四元格局：4种各一时轮转活跃元素，当前提供全属性与元素轮转基底。",
	"金水火土·破界": "四元格局：缺木，爆发和暴击更强，但自然回复受损。",
	"木火土水·四象归元": "四元格局：缺金，回复、防护和燃烧形成稳定循环。",
	"五行圆满": "五行各一时激活：暴击、回复、冷却、伤害、减伤各少量提升，并周期触发小型归元脉冲。",
}
const TAG_COMBO_DESCS := {
	"破甲墨锋": "锐+裂：破甲/暴击方向，当前提供额外暴击率。",
	"爆燃裂帛": "焚+裂：燃烧爆裂方向，当前强化燃烧伤害。",
	"摄魂回元": "吸+魂：击杀回元方向，当前击杀回复生命。",
	"寒蚀入骨": "冻+蚀：减速侵蚀方向，当前提高减速概率。",
	"山门不动": "厚+障：防御屏障方向，当前提高减伤。",
}
const TAG_DESCS := {
	"锐": "锋锐、切割、暴击相关。",
	"迅": "身法、移速、闪避节奏相关。",
